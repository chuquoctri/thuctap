...
const ThuVien_LeHoiScreen = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const [prevButtonPressed, setPrevButtonPressed] = useState(false);
  const [nextButtonPressed, setNextButtonPressed] = useState(false);

  const images = [
    {name: 'Lễ hội biển Nha Trang 1', source: require('./assets/lehoi_1.jpg')},
    {name: 'Lễ hội biển Nha Trang 2', source: require('./assets/lehoi_2.webp')},
    {name: 'Lễ hội biển Nha Trang 3', source: require('./assets/lehoi_3.webp')},
...
export default ThuVien_LeHoiScreen;
