...
const ThuVien_ThapChamScreen = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const [prevButtonPressed, setPrevButtonPressed] = useState(false);
  const [nextButtonPressed, setNextButtonPressed] = useState(false);

  const images = [
    {name: 'Tháp chàm 1', source: require('./assets/thapcham_1.jpg')},
    {name: 'Tháp chàm 2', source: require('./assets/thapcham_2.jpg')},
    {name: 'Tháp chàm 3', source: require('./assets/thapcham_3.jpg')},
...
export default ThuVien_ThapChamScreen;
