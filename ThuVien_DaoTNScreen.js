...
const ThuVien_DaoTNScreen = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);
  const [prevButtonPressed, setPrevButtonPressed] = useState(false);
  const [nextButtonPressed, setNextButtonPressed] = useState(false);

  const images = [
    {name: 'Đảo Trí Nguyên 1', source: require('./assets/dao_1.jpg')},
    {name: 'Đảo Trí Nguyên 2', source: require('./assets/dao_2.jpg')},
    {name: 'Đảo Trí Nguyên 3', source: require('./assets/dao_3.webp')},
...
export default ThuVien_DaoTNScreen;
